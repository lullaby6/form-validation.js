...
let fvFeedbacks = (name, value) => ({
    'fv-required': `${name} es obligatorio`,
    'fv-min-length': `${name} debe tener ${value} o mas caracteres`,
    'fv-max-length': `${name} debe tener ${value} o menos caracteres`,
    'fv-min': `${name} debe ser mayor o igual a ${value}`,
    'fv-max': `${name} debe ser menor o igual a ${value}`,
    'fv-include': `${name} debe inluir "${value}"`,
    'fv-exclude': `${name} no debe incluir "${value}"`,
    'fv-start': `${name} debe comenzar con "${value}"`,
    'fv-no-start': `${name} no debe comenzar con "${value}"`,
    'fv-end': `${name} debe terminar con "${value}"`,
    'fv-no-end': `${name} no debe terminar con "${value}"`,
    'fv-upper': `${name} debe ser solo mayuscula`,
    'fv-lower': `${name} debe ser solo minuscula`,
    'fv-trim': `${name} no debe tener espacios`,
    'fv-regex': `${name} no coincide con "${value}"`,
    'fv-int': `${name} debe ser un numero entero`,
    'fv-float': `${name} debe ser un numero decimal`,
    'fv-string': `${name} debe ser un texto`,
    'fv-email': `${name} debe ser un email`,
    'fv-url': `${name} debe ser una url`,
    'fv-http-url': `${name} debe ser una http url`,
    'fv-ip': `${name} debe ser una ipv4`,
    'fv-equal': `${name} debe ser igual a "${value}"`,
})
